...
int main()
{
  ...
  char op_mnemonic[26][10] = {"LDA", "STA", "SUB", "MUL", "LDCH", "STCH", "ADD", "COMP", "RSUB",
                              "JEQ", "JGT", "JLT", "LDX", "LDB", "COMP", "TIX"};

  char op_opcode[26][10] = {"00", "0C", "1C", "20", "50", "54", "18", "28", "4C", "30", "34", "38",
                            "04", "68", "28", "2C"};
    ...
    while (strcmp(mnemonic, "END") != 0)
    {
        if (strcmp(label, ".") != 0)
        {
            ...
            {
                x = atoi(operand); /*change RESB's string mnemonic into integer --> x */
                address += x;
            }
            else
                address += 3;
